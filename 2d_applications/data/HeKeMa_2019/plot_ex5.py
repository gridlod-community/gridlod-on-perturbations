...
epsCoarse, to_be_updated, complete_errors, tmp_errors, rel_errors, TOLt, uFine, uFineLOD, NWorldCoarse, NFine, a_ref, a_pert, a_trans, f_ref, f_trans, E_ft = restore_all_data(ROOT, k, N)
