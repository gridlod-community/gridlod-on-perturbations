...
num_dots = 32
aFine_ref_mask = np.min(np.abs(np.sin(np.pi*num_dots*xt)), axis=1) < 0.5
aFine_ref = 0.1*aFine_ref_mask + 1*np.logical_not(aFine_ref_mask)
...
#bending_perturbation = perturbations.Oscillation(world, num_dots)
