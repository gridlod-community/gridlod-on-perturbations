...
# cq1[:, left - 1] = walk_with_perturbation * 3/ 4
# cq1[:, left - 2] = walk_with_perturbation *2 / 4
# cq1[:, left - 3] = walk_with_perturbation *1 / 4
# cq1[:, right ] = walk_with_perturbation* 3/ 4
# cq1[:, right +1 ] = walk_with_perturbation * 2/ 4
# cq1[:, right +2 ] = walk_with_perturbation * 1/ 4
# cq1[:, right +3 ] = walk_with_perturbation * 0
# cq1[:, right +4 ] = - walk_with_perturbation * 1/ 4
# cq1[:, right +5:righter ] = - walk_with_perturbation * 1/2
# cq1[:, righter ] = - walk_with_perturbation* 1/ 4
...
print('compute error indicators')
epsFine, epsCoarse = zip(*map(computeIndicators_classic, range(world.NtCoarse)))
