...
ROOT = '../../2d_applications/data/Axels_Experiment/bending_dots'
...
bending_perturbation = perturbations.BendingInOneArea(world, area=[0.25,0.5], bending_factor=20)
...
plt.figure("Transformed coefficient")
...
store_all_data(ROOT, k, N, epsCoarse, to_be_updatedT, energy_errorT, tmp_errorT, TOLt, uFineFull_trans, uFineFull_trans_LOD, NFine, NWorldCoarse, aFine_ref, aFine_trans, f_ref, name="test_init")
